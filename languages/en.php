...
return [
    ...
    'entity_lists:admin:elgg_objects:table:header:name' => 'Name',
    'entity_lists:admin:elgg_objects:table:header:username' => 'Username',
    'entity_lists:admin:elgg_objects:table:header:email' => 'email',
